...
import { bookCreate, bookContentCreate, bookRead, bookUpdate, bookDelete, bookImg } from '../controllers/book.controller.js';
...
// 책 사진 저장
bookRouter.post('/img', imageUploader.array('image', 20), bookImg);