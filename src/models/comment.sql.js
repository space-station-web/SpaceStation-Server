...
export const getCommentSql = "SELECT * FROM comment WHERE comment_id = ? AND user_id = ?";

export const deleteCommentSql = "DELETE FROM comment WHERE comment_id = ? AND user_id = ?";
